  ...
  return (
    <header className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav className="md:md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            <a className="mr-5 hover:text-gray-900">목적</a>
            <a className="mr-5 hover:text-gray-900">시연</a>
            <a className="md:mr-5 hover:text-gray-900">기술</a>
            </nav>
