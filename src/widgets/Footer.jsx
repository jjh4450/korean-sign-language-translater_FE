    ...
    <footer className="text-gray-600 body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <a href="https://blog.jeje.work" className="text-gray-500 flex items-center justify-center h-6 w-6" target="_blank" rel="noopener noreferrer">
            <BlogIcon />
          </a>
          <a href="https://jeje.work/github" className="ml-3 text-gray-500 flex items-center justify-center h-6 w-6" target="_blank" rel="noopener noreferrer">
            <GithubIcon />
          </a>
          <a href="https://jeje.work/linkedin" className="ml-3 text-gray-500 flex items-center justify-center h-6 w-6" target="_blank" rel="noopener noreferrer">
            <LinkedinIcon />
          </a>
        </span>
      </div>
...
const BlogIcon = () => (
  <svg fill="currentColor" stroke="currentColor" className="icon" viewBox="0 0 512 512" style={{ width: '100%', height: '100%' }}>
...
const GithubIcon = () => (
  <svg viewBox="0 0 97.707 97.707" style={{ width: '100%', height: '100%' }} className="icon" fill="currentColor">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
const LinkedinIcon = () => (
  <svg viewBox="0 0 24 24" style={{ width: '100%', height: '100%' }} className="icon" fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" >
