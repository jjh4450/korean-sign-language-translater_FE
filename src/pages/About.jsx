      ...
      <div className="container px-5 py-24 mx-auto lg:px-20 lg:w-4/5">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <p className="mx-auto text-gray-500 lg:w-2/3 mb-8">
            그렇지 않습니다. 청각 장애인들에게 수어는 한국어와는 별개의 독립된 시각 언어입니다. 한글 자막은 한국어에 기반을 두고 있어 <strong>"불이 났어요~ ㅎㅎ", "불이 났어요!!"</strong> 등과 같이 문장 끝에 다양한 말투를 표현할 수 있지만, 이는 청각 정보에 의존하는 표현 방식으로, 선천적 청각 장애인들은 <strong>이를 전혀 인지할 수 없습니다.</strong> 반면 수어는 시각 정보를 통해 말투와 정서를 표현할 수 있어 청각 장애인들에게 자연스러운 의사소통 방식이 됩니다. 법무 관련 관공서에서 원하는 의사소통 방법, 직장에서 사용하길 원하는 의사소통 방법에 대해 조사한 자료에 따르면 <strong>각각 66%와 55%의 청각 장애인 분들이 수어를 원한다</strong>고 합니다.
