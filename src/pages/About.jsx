      ...
      <div className="container px-5 py-24 mx-auto lg:px-20 lg:w-4/5">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <p className="mx-auto text-gray-500 lg:w-2/3 mb-8">
            그렇지 않습니다. 청각 장애인들에게 수어는 한국어와는 별개의 독립된 시각 언어입니다. 한글 자막은 한국어에 기반을 두고 있어 "불이 났어요~ ㅎㅎ", "불이 났어요!!" 등과 같이 문장 끝에 다양한 말투를 표현할 수 있지만, 이는 청각 정보에 의존하는 표현 방식으로, 선천적 청각 장애인들은 이를 전혀 인지할 수 없습니다. 반면 수어는 시각 정보를 통해 말투와 정서를 표현할 수 있어 청각 장애인들에게 자연스러운 의사소통 방식이 됩니다. 법무 관련 관공서에서 원하는 의사소통 방법, 직장에서 사용하길 원하는 의사소통 방법에 대해 조사한 자료에 따르면 각각 66%와 55%의 청각 장애인 분들이 수어를 원한다고 합니다.
          </p>
        </div>
        ...
        <div className="flex flex-wrap mb-20">
          ...
          <div className="lg:w-1/2 w-full flex flex-col justify-center px-4 lg:px-8">
            ...
            <p className="text-gray-500 mt-4">
              기존 수어 번역 프로그램들은 지문자 번역 방식을 사용하여 청각 장애인들의 이해도를 저하시키는 한계가 있습니다. 또한 많은 프로그램들이 개발 단계에 머물러 있거나 업데이트가 중단되어 접근성과 실용성이 낮은 실정입니다. O-LANGE는 온전한 수어 형태소를 제공하며, 음성 인식을 통한 실시간 번역 서비스를 제공하는 시스템을 구현하여 이러한 문제를 해결하고자 합니다.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap mb-20">
          <div className="lg:w-1/2 w-full flex flex-col justify-center px-4 lg:px-8 mb-8 lg:mb-0">
            ...
            <p className="text-gray-500 mt-4">
              지문자는 각 수어의 특징을 표기하는 것이 아닌 단어를 표기하는 방법으로, 이는 수어의 의미를 단어로 표기하는 것입니다. 예를 들어, '가나다'를 'ㄱ ㅏ ㄴ ㅏ ㄷ ㅏ'로 표기하는 것과 같습니다. 이는 매우 비효율적이며, 수어의 특징을 표기하지 않기 때문에 수어를 이해하는 데 어려움이 있습니다. O-LANGE는 이러한 지문자를 사용하지 않고, 형태소를 기반으로 하는 수어 표기법을 시범적으로 구현했습니다. 비록 미비한 부분이 많지만, 이러한 시도가 더 많이 이루어지길 바랍니다.
            </p>
          </div>
        ...
        <div className="flex flex-wrap mb-20">
          ...
          <div className="lg:w-1/2 w-full flex flex-col justify-center px-4 lg:px-8">
            ...
            <p className="text-gray-500 mt-4">
              O-LANGE는 청각 장애인들의 정보 접근성과 의사소통 편의성을 향상시키기 위해 실시간 음성 인식 수어 번역 프로그램을 개발하는 프로젝트입니다. 이 프로젝트는 국립국어원 한국 수어사전의 데이터를 활용하여 개발되었습니다. 처음에는 간단히 정적 웹사이트로 구현하였으나, 접근성을 개선하기 위해 동적인 웹사이트 구현이 필요했습니다. 그래서 React와 Tailwind CSS를 사용하여 사이트를 구성하게 되었습니다. 음성 인식 기능은 webkitSpeechRecognition을 사용하여 구현되었으며, FastAPI 기반의 웹소켓을 사용하여 백엔드를 구성했습니다. 이를 통해 웹에서 음성을 입력받아 번역된 수어를 보여줄 수 있게 되었습니다. 이 모든 소스 코드는 footer에 있는 제 깃허브에서 확인하실 수 있습니다. 2021년에 저와 함께 이 훌륭한 프로젝트를 진행해 3년 뒤 온전한 서비스로 구현할 초석을 다져준 최재경, 위재현, 박상현, 정윤호 학생에게 감사의 말씀을 드립니다.
            </p>
          </div>
        </div>
      </div>
