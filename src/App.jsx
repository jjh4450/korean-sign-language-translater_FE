...
const Header = () => {
  return (
    <header className="header">
      <div className="logo">O-LANGE</div>
      <nav className="nav">
...
const Main = () => {
  return (
    <main className="main fade-in">
      <h1>소리를 언어로 바꾸다</h1>
      <p>이 프로그램은 청각 장애인 분들을 위해 소리 정보를 수어로 실시간 번역하여 제공합니다.</p>
      <p>일상 생활에서의 의사소통뿐만 아니라 응급 상황에서 정보 접근을 향상시키는 데 중요한 역할을 합니다.</p>
      <p>이를 통해 사용자는 자신이 좋아하는 영상 컨텐츠를 더 자유롭게 시청하고, 온라인 학습 환경에서도 교육의 기회를 평등하게 누릴 수 있습니다.</p>
    </main>
  );
};
      ...
      <div className="container">
        <div className="footer-content">
          <p className="footer-text">
            © 2024 Junhwan Cho —
            <a href="mailto:jjh4450git@gmail.com">jjh4450git@gmail.com</a>
          </p>
          <div className="social-icons">
            <a href="https://blog.jeje.work" className="social-icon blog" target="_blank" rel="noopener noreferrer">
              <BlogIcon />
            </a>
            <a href="https://jeje.work/github" className="social-icon github" target="_blank" rel="noopener noreferrer">
              <GithubIcon />
            </a>
            <a href="https://jeje.work/linkedin" className="social-icon linkedin" target="_blank" rel="noopener noreferrer">
              <LinkedinIcon />
            </a>
          </div>
        </div>
